...
return (new CustomEvent(event_name,(function (){var obj35564 = ({"detail":data});
return obj35564;
})()));
} else {
...
var f = (function (){var pred__35571 = cljs.core._EQ_;
var expr__35572 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35571.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35572))){
return ((function (pred__35571,expr__35572){
return (function (p1__35565_SHARP_){
return console.warn(p1__35565_SHARP_);
});
;})(pred__35571,expr__35572))
} else {
if(cljs.core.truth_(pred__35571.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35572))){
return ((function (pred__35571,expr__35572){
return (function (p1__35566_SHARP_){
return console.debug(p1__35566_SHARP_);
});
;})(pred__35571,expr__35572))
} else {
if(cljs.core.truth_(pred__35571.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35572))){
return ((function (pred__35571,expr__35572){
return (function (p1__35567_SHARP_){
return console.error(p1__35567_SHARP_);
});
;})(pred__35571,expr__35572))
} else {
return ((function (pred__35571,expr__35572){
return (function (p1__35568_SHARP_){
return console.log(p1__35568_SHARP_);
});
;})(pred__35571,expr__35572))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35575){
...
var eval_fn = cljs.core.get.call(null,map__35576__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__35578_SHARP_);
});})(new_def))
);
...
return (function (p__35579){
var vec__35580 = p__35579;
var ky = cljs.core.nth.call(null,vec__35580,(0),null);
var v = cljs.core.nth.call(null,vec__35580,(1),null);
...
}catch (e35585){if((e35585 instanceof Error)){
var e = e35585;
return not_found;
} else {
throw e35585;
...
//# sourceMappingURL=utils.js.map?rel=1642872179596
