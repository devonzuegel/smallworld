...
var G__31926 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__31926;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__31927 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__31927,ch);
...
if(("\\" === ch__$1)){
var ch_31928__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_31928__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_31928__$2);
} else {
}

var G__31929 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__31929;
continue;
}
}
...
var G__31940 = cljs.core.conj_BANG_.call(null,a,form);
a = G__31940;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__31941 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__31942 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__31942;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__31941;
}});
/**
...
var vec__31949 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__31949,(0),null);
var start_column = cljs.core.nth.call(null,vec__31949,(1),null);
...
var vec__31952 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__31952,(0),null);
var end_column = cljs.core.nth.call(null,vec__31952,(1),null);
...
var vec__31955 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__31955,(0),null);
var start_column = cljs.core.nth.call(null,vec__31955,(1),null);
...
var vec__31958 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__31958,(0),null);
var end_column = cljs.core.nth.call(null,vec__31958,(1),null);
...
var sb = (function (){var G__31961 = (new goog.string.StringBuffer());
G__31961.append(initch);
...
var G__31963 = (function (){var G__31962 = sb;
G__31962.append(ch);

return G__31962;
})();
var G__31964 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__31963;
ch = G__31964;
continue;
}
...
switch (G__31967) {
case "\\":
var G__31971 = (function (){var G__31968 = sb;
G__31968.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__31968;
})();
var G__31972 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__31971;
ch = G__31972;
continue;
...
break;
default:
var G__31973 = (function (){var G__31969 = sb;
G__31969.append(ch);

return G__31969;
})();
var G__31974 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__31973;
ch = G__31974;
continue;
...
var vec__31975 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__31975,(0),null);
var end_column = cljs.core.nth.call(null,vec__31975,(1),null);
...
var vec__31978 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__31978,(0),null);
var column = cljs.core.nth.call(null,vec__31978,(1),null);
...
var vec__31983 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__31983,(0),null);
var column = cljs.core.nth.call(null,vec__31983,(1),null);
...
var line = cljs.core.nth.call(null,vec__31988,(0),null);
var column = cljs.core.nth.call(null,vec__31988,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var G__31999 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__31999,true,null,opts,pending_forms);
...
var G__32000 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__32000)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__32000)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__32000)){
...
var _STAR_suppress_read_STAR__orig_val__32001 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__32002 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__32002;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__32001;
}});
...
var G__32003 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__32003,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__32003,rdr,first_line);
...
var G__32007 = matched;
var G__32008 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__32007;
finished = G__32008;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__32009 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__32010 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__32010;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__32009;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__32011 = cljs.tools.reader.arg_env;
var arg_env_temp_val__32012 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__32012;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__32013 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__32013,"(");
...
var G__32014 = (i + (1));
var G__32015 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__32011;
}});
/**
...
var ch = temp__5751__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__32016 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__32016);
...
var G__32017 = cljs.core.next.call(null,s__$1);
var G__32018 = ret;
s__$1 = G__32017;
r = G__32018;
continue;
...
var G__32019 = cljs.core.next.call(null,s);
var G__32020 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__32019;
key_vals = G__32020;
continue;
} else {
...
var gensym_env_orig_val__32024 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__32025 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__32025;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__32024;
}});
...
var temp__5751__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__32026 = token;
var G__32026__$1 = (((G__32026 == null))?null:cljs.core.subs.call(null,G__32026,(1)));
var G__32026__$2 = (((G__32026__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__32026__$1));
var G__32026__$3 = (((G__32026__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__32026__$2));
var G__32026__$4 = (((G__32026__$3 == null))?null:cljs.core.symbol.call(null,G__32026__$3));
if((G__32026__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__32026__$4);
}
})():(function (){var G__32027 = token;
var G__32027__$1 = (((G__32027 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__32027));
if((G__32027__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__32027__$1);
}
})()
));
if(cljs.core.truth_(temp__5751__auto__)){
...
}catch (e32034){if((e32034 instanceof Error)){
var e = e32034;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__32038,reader){
...
var opts = map__32039__$1;
var eof = cljs.core.get.call(null,map__32039__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4730__auto___32047 = arguments.length;
var i__4731__auto___32048 = (0);
while(true){
if((i__4731__auto___32048 < len__4730__auto___32047)){
args__4736__auto__.push((arguments[i__4731__auto___32048]));

var G__32049 = (i__4731__auto___32048 + (1));
i__4731__auto___32048 = G__32049;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq32045){
var G__32046 = cljs.core.first.call(null,seq32045);
var seq32045__$1 = cljs.core.next.call(null,seq32045);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32046,seq32045__$1);
});


//# sourceMappingURL=reader.js.map?rel=1642872178626
